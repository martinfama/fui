...
int main(void) {
  const struct CMUnitTest tests[] = {
      ...
      cmocka_unit_test_setup_teardown(test_draw_pixel, setup_framebuffer,
                                      teardown_framebuffer),
      cmocka_unit_test_setup_teardown(test_render_framebuffer,
                                      setup_framebuffer, teardown_framebuffer),
      cmocka_unit_test(test_debugui_init_cleanup),
      cmocka_unit_test_setup_teardown(test_screenshot, setup_framebuffer,
                                      teardown_framebuffer),
  };
